...
export default function ChatInterface() {
  ...
  const handleTranslate = async (index: number, textToTranslate: string) => {
    ...
    if (updatedMessages[index].translatedText && updatedMessages[index].showTranslation) {
        ...
        {messages.length === 0 ? (
          <div className="flex items-center justify-center h-full text-center">
            <div className="space-y-4">
              ...
              <h3 className="text-xl font-semibold text-gray-700">Start Your Conversation</h3>
              <p className="text-gray-500">Type a message below to begin practicing your target language</p>
            </div>
          </div>
        ) : (
              ...
              >
                  ...
                  <div className="flex items-center justify-start mt-3 pt-2 border-t border-gray-200">
                    <div className="flex items-center space-x-3">
                      <button
                        ...
                        title={msg.showTranslation && msg.translatedText ? 'Hide Translation' : 'Show Translation'}
                      >
                        <FaLanguage size={12} />
                        <span>{msg.showTranslation && msg.translatedText ? 'Hide' : 'Translate'}</span>
                      </button>
                      <button
                ...
                {msg.showTranslation && msg.translatedText && (
                  <div className="mt-3 p-3 bg-white/80 rounded-lg border border-gray-200">
                    <p className="text-xs font-medium text-gray-600 mb-1">🌍 Translation:</p>
